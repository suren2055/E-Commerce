...
using E_Commerce.WEB.ViewModels.Annotations;
using E_Commerce.WEB.ViewModels.Converters;
...
public class Order
{
    ...
    private List<SelectListItem> GetActionCodesByCurrentState()
    {
        ...
        actions.ForEach(action => { result.Add(new SelectListItem {Text = action.Name, Value = action.Code}); });
